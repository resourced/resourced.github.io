`GET http://localhost:55655/api/metrics/{id:[0-9]+}/hosts/{host}/15m`
...
aggr | '' | string | Allows user to choose between avg, max, min, or sum. If nothing is defined, then all four will be returned.
